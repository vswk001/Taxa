export default {
  ...
  editor: {
    ...
    saveFailed: 'Save failed — your latest edits are not stored',
    tagPlaceholder: 'Tag',
    newTab: 'New Note',
    closeTab: 'Close tab',
    newNoteTitle: 'New Note',
  ...
  ai: {
    ...
    modeAsk: 'Ask',
    modeAskDesc: 'Q&A grounded in your notes',
  ...
  settings: {
    ...
    quickCaptureEnable: 'Global capture hotkey',
    quickCaptureShortcut: 'Shortcut',
    quickCaptureHint: 'System-wide hotkey that opens a small capture window from anywhere.',
    language: 'Language',
    aboutTitle: 'Taxa',
    ...
    closeToTrayHint: 'The quick-capture hotkey keeps working while the app is in the tray.',
    dataSection: 'Data',
  ...
  tags: {
    ...
    empty: 'No tags yet',
    rename: 'Rename tag',
    renameHint: 'Renaming a tag updates every note that uses it.',
  },
  palette: {
    placeholder: 'Search notes and commands...',
    empty: 'No matches',
    kind: { note: 'Note', folder: 'Folder', action: 'Action' },
    action: {
      'new-note': 'New Note',
      daily: 'Daily Note',
      search: 'Search',
